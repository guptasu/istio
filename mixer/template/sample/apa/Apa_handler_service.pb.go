...
type InstanceParam struct {
	...
	Res3Map                        map[string]*Resource3InstanceParam `protobuf:"bytes,8,rep,name=res3_map" json:"res3_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
...
type Resource1InstanceParam struct {
	...
	SelfRefRes1 *Resource1InstanceParam `protobuf:"bytes,3,opt,name=self_ref_res1" json:"self_ref_res1,omitempty"`
...
type Resource2InstanceParam struct {
	...
	Res3Map map[string]*Resource3InstanceParam `protobuf:"bytes,3,rep,name=res3_map" json:"res3_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func valueToGoStringApaHandlerService(v interface{}, typ string) string {
...
var fileDescriptorApaHandlerService = []byte{
	...
	,
}
