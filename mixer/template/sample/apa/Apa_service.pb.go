...
// source: mixer/template/sample/apa/Apa_service.proto

/*
	Package istio_mixer_adapter_sample_myapa is a generated protocol buffer package.

	It is generated from these files:
		mixer/template/sample/apa/Apa_service.proto
...
func (*InstanceParam) Descriptor() ([]byte, []int) { return fileDescriptorApaService, []int{0} }
...
func (*Resource1InstanceParam) Descriptor() ([]byte, []int) { return fileDescriptorApaService, []int{1} }
...
func (*Resource2InstanceParam) Descriptor() ([]byte, []int) { return fileDescriptorApaService, []int{2} }
...
func (*Resource3InstanceParam) Descriptor() ([]byte, []int) { return fileDescriptorApaService, []int{3} }
...
func valueToGoStringApaService(v interface{}, typ string) string {
...
func (m *InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Int64Primitive) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintApaService(dAtA, i, uint64(len(m.Int64Primitive)))
		i += copy(dAtA[i:], m.Int64Primitive)
	}
	if len(m.BoolPrimitive) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintApaService(dAtA, i, uint64(len(m.BoolPrimitive)))
		i += copy(dAtA[i:], m.BoolPrimitive)
	}
	if len(m.DoublePrimitive) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintApaService(dAtA, i, uint64(len(m.DoublePrimitive)))
		i += copy(dAtA[i:], m.DoublePrimitive)
	}
	if len(m.StringPrimitive) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintApaService(dAtA, i, uint64(len(m.StringPrimitive)))
	...
	if len(m.DimensionsFixedInt64ValueDType) > 0 {
		for k, _ := range m.DimensionsFixedInt64ValueDType {
			...
			mapSize := 1 + len(k) + sovApaService(uint64(len(k))) + 1 + len(v) + sovApaService(uint64(len(v)))
			i = encodeVarintApaService(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintApaService(dAtA, i, uint64(len(k)))
			i += copy(dAtA[i:], k)
			dAtA[i] = 0x12
			i++
			i = encodeVarintApaService(dAtA, i, uint64(len(v)))
			i += copy(dAtA[i:], v)
		}
	}
	if len(m.TimeStamp) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintApaService(dAtA, i, uint64(len(m.TimeStamp)))
		i += copy(dAtA[i:], m.TimeStamp)
	}
	if len(m.Duration) > 0 {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintApaService(dAtA, i, uint64(len(m.Duration)))
	...
	if len(m.Res3Map) > 0 {
		for k, _ := range m.Res3Map {
			...
			if v != nil {
				msgSize = v.Size()
				msgSize += 1 + sovApaService(uint64(msgSize))
			}
			mapSize := 1 + len(k) + sovApaService(uint64(len(k))) + msgSize
			i = encodeVarintApaService(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintApaService(dAtA, i, uint64(len(k)))
			...
			if v != nil {
				dAtA[i] = 0x12
				i++
				i = encodeVarintApaService(dAtA, i, uint64(v.Size()))
	...
	if len(m.OptionalIP) > 0 {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintApaService(dAtA, i, uint64(len(m.OptionalIP)))
		i += copy(dAtA[i:], m.OptionalIP)
	}
	if len(m.Email) > 0 {
		dAtA[i] = 0x52
		i++
		i = encodeVarintApaService(dAtA, i, uint64(len(m.Email)))
...
func (m *Resource1InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Str) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintApaService(dAtA, i, uint64(len(m.Str)))
		i += copy(dAtA[i:], m.Str)
	}
	if m.ResRef2 != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintApaService(dAtA, i, uint64(m.ResRef2.Size()))
	...
	if m.SelfRefRes1 != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintApaService(dAtA, i, uint64(m.SelfRefRes1.Size()))
...
func (m *Resource2InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Res3 != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintApaService(dAtA, i, uint64(m.Res3.Size()))
...
func encodeVarintApaService(dAtA []byte, offset int, v uint64) int {
	for v >= 1<<7 {
...
func (m *InstanceParam) Size() (n int) {
	...
	if len(m.DimensionsFixedInt64ValueDType) > 0 {
		for k, v := range m.DimensionsFixedInt64ValueDType {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovApaService(uint64(len(k))) + 1 + len(v) + sovApaService(uint64(len(v)))
			n += mapEntrySize + 1 + sovApaService(uint64(mapEntrySize))
		}
	}
	l = len(m.TimeStamp)
	if l > 0 {
	...
	if len(m.Res3Map) > 0 {
		for k, v := range m.Res3Map {
			...
			if v != nil {
				l = v.Size()
				l += 1 + sovApaService(uint64(l))
			}
			mapEntrySize := 1 + len(k) + sovApaService(uint64(len(k))) + l
			n += mapEntrySize + 1 + sovApaService(uint64(mapEntrySize))
		}
	}
	l = len(m.OptionalIP)
	...
	if len(m.AttributeBindings) > 0 {
		for k, v := range m.AttributeBindings {
			...
			_ = v
			mapEntrySize := 1 + len(k) + sovApaService(uint64(len(k))) + 1 + len(v) + sovApaService(uint64(len(v)))
			n += mapEntrySize + 5 + sovApaService(uint64(mapEntrySize))
		}
	}
	return n
}
...
func sovApaService(x uint64) (n int) {
	for {
		n++
		x >>= 7
		if x == 0 {
...
func sozApaService(x uint64) (n int) {
	return sovApaService(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func valueToStringApaService(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *InstanceParam) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowApaService
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthApaService
			}
		...
		case 5:
			...
			for iNdEx < postIndex {
				...
				if fieldNum == 1 {
					...
					iNdEx = entryPreIndex
					skippy, err := skipApaService(dAtA[iNdEx:])
					if err != nil {
						return err
					}
					if skippy < 0 {
...
func skipApaService(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowApaService
			}
			if iNdEx >= l {
		...
		case 2:
			...
			iNdEx += length
			if length < 0 {
				return 0, ErrInvalidLengthApaService
			}
			return iNdEx, nil
		case 3:
			for {
				...
				next, err := skipApaService(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthApaService = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowApaService   = fmt.Errorf("proto: integer overflow")
)

func init() {
	proto.RegisterFile("mixer/template/sample/apa/Apa_service.proto", fileDescriptorApaService)
}

var fileDescriptorApaService = []byte{
	// 693 bytes of a gzipped FileDescriptorProto
	,
}
