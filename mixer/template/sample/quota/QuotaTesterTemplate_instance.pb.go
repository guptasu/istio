...
// source: mixer/template/sample/quota/QuotaTesterTemplate_instance.proto

/*
	Package istio_mixer_adapter_sample_quota is a generated protocol buffer package.

	It is generated from these files:
		mixer/template/sample/quota/QuotaTesterTemplate_instance.proto
...
func (*Type) Descriptor() ([]byte, []int) { return fileDescriptorQuotaTesterTemplateInstance, []int{0} }
...
func (*Res1Type) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateInstance, []int{1}
}
...
func (*Res2Type) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateInstance, []int{2}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateInstance, []int{3}
}
...
func (*Res1InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateInstance, []int{4}
}
...
func (*Res2InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateInstance, []int{5}
}
...
func valueToGoStringQuotaTesterTemplateInstance(v interface{}, typ string) string {
...
func (m *Type) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Dimensions) > 0 {
		for k, _ := range m.Dimensions {
			...
			i++
			v := m.Dimensions[k]
			mapSize := 1 + len(k) + sovQuotaTesterTemplateInstance(uint64(len(k))) + 1 + sovQuotaTesterTemplateInstance(uint64(v))
			i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(k)))
			i += copy(dAtA[i:], k)
			dAtA[i] = 0x10
			i++
			i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(v))
		}
	}
	if m.Res1 != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(m.Res1.Size()))
...
func (m *Res1Type) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Value != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(m.Value))
	}
	if len(m.Dimensions) > 0 {
		for k, _ := range m.Dimensions {
			dAtA[i] = 0x12
	...
	if m.Res2 != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(m.Res2.Size()))
	...
	if len(m.Res2Map) > 0 {
		for k, _ := range m.Res2Map {
			...
			if v != nil {
				msgSize = v.Size()
				msgSize += 1 + sovQuotaTesterTemplateInstance(uint64(msgSize))
			}
			mapSize := 1 + len(k) + sovQuotaTesterTemplateInstance(uint64(len(k))) + msgSize
			i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(k)))
			...
			if v != nil {
				dAtA[i] = 0x12
				i++
				i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(v.Size()))
...
func (m *InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Dimensions) > 0 {
		for k, _ := range m.Dimensions {
			...
			i++
			v := m.Dimensions[k]
			mapSize := 1 + len(k) + sovQuotaTesterTemplateInstance(uint64(len(k))) + 1 + len(v) + sovQuotaTesterTemplateInstance(uint64(len(v)))
			i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(k)))
			...
			dAtA[i] = 0x12
			i++
			i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(v)))
			i += copy(dAtA[i:], v)
		}
	}
	if len(m.BoolMap) > 0 {
...
func (m *Res1InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(m.Value)))
	...
	if len(m.Int64Primitive) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(m.Int64Primitive)))
		i += copy(dAtA[i:], m.Int64Primitive)
	}
	if len(m.BoolPrimitive) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(m.BoolPrimitive)))
		i += copy(dAtA[i:], m.BoolPrimitive)
	}
	if len(m.DoublePrimitive) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(m.DoublePrimitive)))
		i += copy(dAtA[i:], m.DoublePrimitive)
	}
	if len(m.StringPrimitive) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(m.StringPrimitive)))
	...
	if len(m.TimeStamp) > 0 {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(m.TimeStamp)))
		i += copy(dAtA[i:], m.TimeStamp)
	}
	if len(m.Duration) > 0 {
		dAtA[i] = 0x52
		i++
		i = encodeVarintQuotaTesterTemplateInstance(dAtA, i, uint64(len(m.Duration)))
...
func encodeVarintQuotaTesterTemplateInstance(dAtA []byte, offset int, v uint64) int {
	for v >= 1<<7 {
...
func (m *Type) Size() (n int) {
	...
	if len(m.Dimensions) > 0 {
		for k, v := range m.Dimensions {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovQuotaTesterTemplateInstance(uint64(len(k))) + 1 + sovQuotaTesterTemplateInstance(uint64(v))
			n += mapEntrySize + 1 + sovQuotaTesterTemplateInstance(uint64(mapEntrySize))
		}
	}
	if m.Res1 != nil {
		l = m.Res1.Size()
		n += 1 + l + sovQuotaTesterTemplateInstance(uint64(l))
	}
	return n
}
...
func (m *Res1Type) Size() (n int) {
	...
	_ = l
	if m.Value != 0 {
		n += 1 + sovQuotaTesterTemplateInstance(uint64(m.Value))
	}
	if len(m.Dimensions) > 0 {
		for k, v := range m.Dimensions {
			_ = k
	...
	if len(m.Res2Map) > 0 {
		for k, v := range m.Res2Map {
			...
			if v != nil {
				l = v.Size()
				l += 1 + sovQuotaTesterTemplateInstance(uint64(l))
			}
			mapEntrySize := 1 + len(k) + sovQuotaTesterTemplateInstance(uint64(len(k))) + l
			n += mapEntrySize + 1 + sovQuotaTesterTemplateInstance(uint64(mapEntrySize))
		}
	}
	return n
...
func (m *InstanceParam) Size() (n int) {
	...
	if len(m.Dimensions) > 0 {
		for k, v := range m.Dimensions {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovQuotaTesterTemplateInstance(uint64(len(k))) + 1 + len(v) + sovQuotaTesterTemplateInstance(uint64(len(v)))
			n += mapEntrySize + 1 + sovQuotaTesterTemplateInstance(uint64(mapEntrySize))
		}
	}
	if len(m.BoolMap) > 0 {
...
func sovQuotaTesterTemplateInstance(x uint64) (n int) {
	for {
		n++
		x >>= 7
		if x == 0 {
...
func sozQuotaTesterTemplateInstance(x uint64) (n int) {
	return sovQuotaTesterTemplateInstance(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func valueToStringQuotaTesterTemplateInstance(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *Type) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowQuotaTesterTemplateInstance
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthQuotaTesterTemplateInstance
			}
			...
			for iNdEx < postIndex {
				...
				if fieldNum == 1 {
					...
					iNdEx = entryPreIndex
					skippy, err := skipQuotaTesterTemplateInstance(dAtA[iNdEx:])
					if err != nil {
						return err
					}
					if skippy < 0 {
...
func skipQuotaTesterTemplateInstance(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowQuotaTesterTemplateInstance
			}
			if iNdEx >= l {
		...
		case 2:
			...
			iNdEx += length
			if length < 0 {
				return 0, ErrInvalidLengthQuotaTesterTemplateInstance
			}
			return iNdEx, nil
		case 3:
			for {
				...
				next, err := skipQuotaTesterTemplateInstance(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthQuotaTesterTemplateInstance = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowQuotaTesterTemplateInstance   = fmt.Errorf("proto: integer overflow")
)

func init() {
	proto.RegisterFile("mixer/template/sample/quota/QuotaTesterTemplate_instance.proto", fileDescriptorQuotaTesterTemplateInstance)
}

var fileDescriptorQuotaTesterTemplateInstance = []byte{
	// 718 bytes of a gzipped FileDescriptorProto
	,
}
