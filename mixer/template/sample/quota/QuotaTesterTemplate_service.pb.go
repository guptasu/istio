...
// source: mixer/template/sample/quota/QuotaTesterTemplate_service.proto

/*
	Package istio_mixer_adapter_sample_quota is a generated protocol buffer package.

	It is generated from these files:
		mixer/template/sample/quota/QuotaTesterTemplate_service.proto
...
func (*Type) Descriptor() ([]byte, []int) { return fileDescriptorQuotaTesterTemplateService, []int{0} }
...
func (*Res1Type) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateService, []int{1}
}
...
func (*Res2Type) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateService, []int{2}
}
...
func (*HandleQuotaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateService, []int{3}
}
...
func (*HandleQuotaResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateService, []int{4}
}
...
func (*InstanceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateService, []int{5}
}
...
func (*Res1Msg) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateService, []int{6}
}
...
func (*Res2Msg) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateService, []int{7}
}
...
func (*InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateService, []int{8}
}
...
func (*Res1InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateService, []int{9}
}
...
func (*Res2InstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorQuotaTesterTemplateService, []int{10}
}
...
func valueToGoStringQuotaTesterTemplateService(v interface{}, typ string) string {
...
func (m *Type) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Dimensions) > 0 {
		for k, _ := range m.Dimensions {
			...
			i++
			v := m.Dimensions[k]
			mapSize := 1 + len(k) + sovQuotaTesterTemplateService(uint64(len(k))) + 1 + sovQuotaTesterTemplateService(uint64(v))
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(k)))
			i += copy(dAtA[i:], k)
			dAtA[i] = 0x10
			i++
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(v))
		}
	}
	if m.Res1 != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(m.Res1.Size()))
...
func (m *Res1Type) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Value != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(m.Value))
	}
	if len(m.Dimensions) > 0 {
		for k, _ := range m.Dimensions {
			dAtA[i] = 0x12
	...
	if m.Res2 != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(m.Res2.Size()))
	...
	if len(m.Res2Map) > 0 {
		for k, _ := range m.Res2Map {
			...
			if v != nil {
				msgSize = v.Size()
				msgSize += 1 + sovQuotaTesterTemplateService(uint64(msgSize))
			}
			mapSize := 1 + len(k) + sovQuotaTesterTemplateService(uint64(len(k))) + msgSize
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(k)))
			...
			if v != nil {
				dAtA[i] = 0x12
				i++
				i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(v.Size()))
...
func (m *HandleQuotaRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Instances) > 0 {
		for _, msg := range m.Instances {
			dAtA[i] = 0xa
			i++
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(msg.Size()))
	...
	if m.AdapterConfig != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(m.AdapterConfig.Size()))
	...
	if len(m.DedupId) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(m.DedupId)))
...
func (m *HandleQuotaResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Status != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(m.Status.Size()))
...
func (m *InstanceMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.BoolMap) > 0 {
		for k, _ := range m.BoolMap {
			...
			i++
			v := m.BoolMap[k]
			mapSize := 1 + len(k) + sovQuotaTesterTemplateService(uint64(len(k))) + 1 + 1
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(k)))
	...
	if len(m.Name) > 0 {
		...
		dAtA[i] = 0x2
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(m.Name)))
...
func (m *Res1Msg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Int64Primitive != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(m.Int64Primitive))
	}
	if m.BoolPrimitive {
		dAtA[i] = 0x20
		i++
	...
	if len(m.StringPrimitive) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(m.StringPrimitive)))
	...
	if m.TimeStamp != nil {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(m.TimeStamp.Size()))
	...
	if m.Duration != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(m.Duration.Size()))
...
func (m *InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Dimensions) > 0 {
		for k, _ := range m.Dimensions {
			...
			i++
			v := m.Dimensions[k]
			mapSize := 1 + len(k) + sovQuotaTesterTemplateService(uint64(len(k))) + 1 + len(v) + sovQuotaTesterTemplateService(uint64(len(v)))
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(k)))
			...
			dAtA[i] = 0x12
			i++
			i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(v)))
			i += copy(dAtA[i:], v)
		}
	}
	if len(m.BoolMap) > 0 {
...
func (m *Res1InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(m.Value)))
	...
	if len(m.Int64Primitive) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(m.Int64Primitive)))
		i += copy(dAtA[i:], m.Int64Primitive)
	}
	if len(m.BoolPrimitive) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(m.BoolPrimitive)))
		i += copy(dAtA[i:], m.BoolPrimitive)
	}
	if len(m.DoublePrimitive) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(m.DoublePrimitive)))
	...
	if len(m.TimeStamp) > 0 {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(m.TimeStamp)))
		i += copy(dAtA[i:], m.TimeStamp)
	}
	if len(m.Duration) > 0 {
		dAtA[i] = 0x52
		i++
		i = encodeVarintQuotaTesterTemplateService(dAtA, i, uint64(len(m.Duration)))
...
func encodeVarintQuotaTesterTemplateService(dAtA []byte, offset int, v uint64) int {
	for v >= 1<<7 {
...
func (m *Type) Size() (n int) {
	...
	if len(m.Dimensions) > 0 {
		for k, v := range m.Dimensions {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovQuotaTesterTemplateService(uint64(len(k))) + 1 + sovQuotaTesterTemplateService(uint64(v))
			n += mapEntrySize + 1 + sovQuotaTesterTemplateService(uint64(mapEntrySize))
		}
	}
	if m.Res1 != nil {
		l = m.Res1.Size()
		n += 1 + l + sovQuotaTesterTemplateService(uint64(l))
	}
	return n
}
...
func (m *Res1Type) Size() (n int) {
	...
	_ = l
	if m.Value != 0 {
		n += 1 + sovQuotaTesterTemplateService(uint64(m.Value))
	}
	if len(m.Dimensions) > 0 {
		for k, v := range m.Dimensions {
			_ = k
	...
	if len(m.Res2Map) > 0 {
		for k, v := range m.Res2Map {
			...
			if v != nil {
				l = v.Size()
				l += 1 + sovQuotaTesterTemplateService(uint64(l))
			}
			mapEntrySize := 1 + len(k) + sovQuotaTesterTemplateService(uint64(len(k))) + l
			n += mapEntrySize + 1 + sovQuotaTesterTemplateService(uint64(mapEntrySize))
		}
	}
	return n
...
func (m *InstanceMsg) Size() (n int) {
	...
	if len(m.BoolMap) > 0 {
		for k, v := range m.BoolMap {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovQuotaTesterTemplateService(uint64(len(k))) + 1 + 1
			n += mapEntrySize + 1 + sovQuotaTesterTemplateService(uint64(mapEntrySize))
		}
	}
	if m.Res1 != nil {
	...
	l = len(m.Name)
	if l > 0 {
		n += 5 + l + sovQuotaTesterTemplateService(uint64(l))
	}
	return n
}
...
func (m *Res1Msg) Size() (n int) {
	...
	if m.Int64Primitive != 0 {
		n += 1 + sovQuotaTesterTemplateService(uint64(m.Int64Primitive))
	}
	if m.BoolPrimitive {
		n += 2
	}
...
func (m *InstanceParam) Size() (n int) {
	...
	if len(m.Dimensions) > 0 {
		for k, v := range m.Dimensions {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovQuotaTesterTemplateService(uint64(len(k))) + 1 + len(v) + sovQuotaTesterTemplateService(uint64(len(v)))
			n += mapEntrySize + 1 + sovQuotaTesterTemplateService(uint64(mapEntrySize))
		}
	}
	if len(m.BoolMap) > 0 {
...
func sovQuotaTesterTemplateService(x uint64) (n int) {
	for {
		n++
		x >>= 7
		if x == 0 {
...
func sozQuotaTesterTemplateService(x uint64) (n int) {
	return sovQuotaTesterTemplateService(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func valueToStringQuotaTesterTemplateService(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *Type) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowQuotaTesterTemplateService
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthQuotaTesterTemplateService
			}
			...
			for iNdEx < postIndex {
				...
				if fieldNum == 1 {
					...
					iNdEx = entryPreIndex
					skippy, err := skipQuotaTesterTemplateService(dAtA[iNdEx:])
					if err != nil {
						return err
					}
					if skippy < 0 {
...
func skipQuotaTesterTemplateService(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowQuotaTesterTemplateService
			}
			if iNdEx >= l {
		...
		case 2:
			...
			iNdEx += length
			if length < 0 {
				return 0, ErrInvalidLengthQuotaTesterTemplateService
			}
			return iNdEx, nil
		case 3:
			for {
				...
				next, err := skipQuotaTesterTemplateService(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthQuotaTesterTemplateService = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowQuotaTesterTemplateService   = fmt.Errorf("proto: integer overflow")
)

func init() {
	proto.RegisterFile("mixer/template/sample/quota/QuotaTesterTemplate_service.proto", fileDescriptorQuotaTesterTemplateService)
}

var fileDescriptorQuotaTesterTemplateService = []byte{
	...
	,
}
