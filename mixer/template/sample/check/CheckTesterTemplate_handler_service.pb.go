...
func (m *HandleCheckRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Instances) > 0 {
		for _, msg := range m.Instances {
			dAtA[i] = 0xa
			i++
			i = encodeVarintCheckTesterTemplateHandlerService(dAtA, i, uint64(msg.Size()))
...
func (m *InstanceMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Res1 != nil {
		...
		n2, err := m.Res1.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func (m *Res1Msg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Res2 != nil {
		...
		n7, err := m.Res2.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
var fileDescriptorCheckTesterTemplateHandlerService = []byte{
	...
	,
}
