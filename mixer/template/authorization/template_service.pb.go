...
// source: mixer/template/authorization/template_service.proto

/*
	Package authorization is a generated protocol buffer package.

	It is generated from these files:
		mixer/template/authorization/template_service.proto
...
func (*SubjectType) Descriptor() ([]byte, []int) { return fileDescriptorTemplateService, []int{1} }
...
func (*ActionType) Descriptor() ([]byte, []int) { return fileDescriptorTemplateService, []int{2} }
...
func (*HandleAuthorizationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorTemplateService, []int{3}
}
...
func (*HandleAuthorizationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorTemplateService, []int{4}
}
...
// InstanceMsg is constructed by Mixer for the 'authorization' template.
//
// The `authorization` template defines parameters for performing policy
// enforcement within Istio. It is primarily concerned with enabling Mixer
// adapters to make decisions about who is allowed to do what.
...
func (*InstanceMsg) Descriptor() ([]byte, []int) { return fileDescriptorTemplateService, []int{5} }
...
func (*SubjectMsg) Descriptor() ([]byte, []int) { return fileDescriptorTemplateService, []int{6} }
...
func (m *SubjectMsg) GetProperties() map[string]istio_policy_v1beta1.ValueType {
	if m != nil {
		return m.Properties
	}
	return nil
...
func (*ActionMsg) Descriptor() ([]byte, []int) { return fileDescriptorTemplateService, []int{7} }
...
func (m *ActionMsg) GetProperties() map[string]istio_policy_v1beta1.ValueType {
	if m != nil {
		return m.Properties
	}
	return nil
...
func (*InstanceParam) Descriptor() ([]byte, []int) { return fileDescriptorTemplateService, []int{8} }
...
func (*SubjectInstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorTemplateService, []int{9}
}
...
func (*ActionInstanceParam) Descriptor() ([]byte, []int) {
	return fileDescriptorTemplateService, []int{10}
}
...
func (m *Type) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Subject != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTemplateService(dAtA, i, uint64(m.Subject.Size()))
	...
	if m.Action != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTemplateService(dAtA, i, uint64(m.Action.Size()))
...
func (m *HandleAuthorizationRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AdapterConfig != nil {
		...
		n3, err := m.AdapterConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *InstanceMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Action != nil {
		...
		i++
		i = encodeVarintTemplateService(dAtA, i, uint64(m.Action.Size()))
		n6, err := m.Action.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *SubjectMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.User) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTemplateService(dAtA, i, uint64(len(m.User)))
		i += copy(dAtA[i:], m.User)
	}
	if len(m.Groups) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTemplateService(dAtA, i, uint64(len(m.Groups)))
...
func (m *ActionMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Namespace) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTemplateService(dAtA, i, uint64(len(m.Namespace)))
		i += copy(dAtA[i:], m.Namespace)
	}
	if len(m.Service) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTemplateService(dAtA, i, uint64(len(m.Service)))
		i += copy(dAtA[i:], m.Service)
	}
	if len(m.Method) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTemplateService(dAtA, i, uint64(len(m.Method)))
		i += copy(dAtA[i:], m.Method)
	}
	if len(m.Path) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintTemplateService(dAtA, i, uint64(len(m.Path)))
...
func init() {
	proto.RegisterFile("mixer/template/authorization/template_service.proto", fileDescriptorTemplateService)
}
...
var fileDescriptorTemplateService = []byte{
	...
	,
}
