...
func testSimpleTemplateFields(msgInfo MessageInfo, t *testing.T) {
	...
	testField(t, testFileName, msgInfo,
		"val",
		TypeInfo{Name: "istio.mixer.adapter.model.v1beta1.Value", IsValueType: true}, "Val",
	...
	testField(t, testFileName, msgInfo,
		...
		TypeInfo{Name: "map<string, istio.mixer.adapter.model.v1beta1.Value>",
			...
			MapValue: &TypeInfo{Name: "istio.mixer.adapter.model.v1beta1.Value", IsValueType: true},
		},
		"Dimensions",
		TypeInfo{
