...
type InstanceParam struct {
	...
	Res3List                       []*Resource3InstanceParam          `protobuf:"bytes,8,rep,name=res3_list,json=res3List" json:"res3_list,omitempty"`
	Res3Map                        map[string]*Resource3InstanceParam `protobuf:"bytes,9,rep,name=res3_map,json=res3Map" json:"res3_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	// Attribute names to expression mapping. These expressions can use the fields of output object
	// returned from the attribute producing adapters using $out.<fieldName> notation. For example:
	// source.ip : $out.source_pod_ip
	// In the above example, source.ip attribute will be added to the existing attribute list and its value will be set to
	// the value of source_pod_ip field of the output object created by the adapter.
...
func (m *InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Res3List) > 0 {
		for _, msg := range m.Res3List {
			dAtA[i] = 0x42
			i++
			i = encodeVarintApaTmpl(dAtA, i, uint64(msg.Size()))
...
var fileDescriptorApaTmpl = []byte{
	...
	,
}
