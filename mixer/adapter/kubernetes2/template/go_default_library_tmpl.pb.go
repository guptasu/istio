...
// source: bazel-out/local-fastbuild/genfiles/mixer/adapter/kubernetes2/template/go_default_library_tmpl.proto

/*
	Package adapter_template_kubernetes is a generated protocol buffer package.

	It is generated from these files:
		bazel-out/local-fastbuild/genfiles/mixer/adapter/kubernetes2/template/go_default_library_tmpl.proto
...
func (m *InstanceParam) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SourceUid) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintGoDefaultLibraryTmpl(dAtA, i, uint64(len(m.SourceUid)))
		i += copy(dAtA[i:], m.SourceUid)
	}
	if len(m.SourceIp) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintGoDefaultLibraryTmpl(dAtA, i, uint64(len(m.SourceIp)))
		i += copy(dAtA[i:], m.SourceIp)
	}
	if len(m.DestinationUid) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintGoDefaultLibraryTmpl(dAtA, i, uint64(len(m.DestinationUid)))
		i += copy(dAtA[i:], m.DestinationUid)
	}
	if len(m.DestinationIp) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintGoDefaultLibraryTmpl(dAtA, i, uint64(len(m.DestinationIp)))
...
func init() {
	proto.RegisterFile("bazel-out/local-fastbuild/genfiles/mixer/adapter/kubernetes2/template/go_default_library_tmpl.proto", fileDescriptorGoDefaultLibraryTmpl)
}
...
var fileDescriptorGoDefaultLibraryTmpl = []byte{
	...
	,
}
